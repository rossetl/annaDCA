...
def _compute_gradient(
    ...
    """Computes the gradient of the Log-Likelihood for the binary aiRBM.
    ...
    if centered:
        ...
        ) / data["weight"].sum() - (v_gen_centered.T @ h_gen_centered)
        ...
        ) / data["weight"].sum() - (l_gen_centered.T @ h_gen_centered)
