...
class CategoricalLabelLayer(Layer):
    ...
    def __repr__(self) -> str:
        return f"LabelLayer(shape={self.shape}, device={self.bias.device}, dtype={self.bias.dtype})"
...
class LabelNullLayer(Layer):
    ...
    def __repr__(self) -> str:
        return f"LabelNullLayer(shape={self.shape}, device={self.bias.device}, dtype={self.bias.dtype})"