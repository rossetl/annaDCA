...
def add_args_annadca(parser : argparse.ArgumentParser) -> argparse.ArgumentParser:
    ...
    dca_args.add_argument("--potential",          type=str,   default="bernoulli",  help="(Defaults to bernoulli). Type of the hidden potential to be used. Choose among ['bernoulli', 'relu'].")
