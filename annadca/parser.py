...
def add_args_annadca(parser : argparse.ArgumentParser) -> argparse.ArgumentParser:
    ...
    dca_args.add_argument("-d", "--data",         type=Path,  required=True,        help="Filename of the dataset to be used for training the model. Can be a fasta file or a csv file containing the sequences and their annotations.")
    ...
    dca_args.add_argument("-a", "--annotations",  type=Path,  default=None,         help="Path to the file containing the annotations of the sequences.")
